...
const links = [
    ...
    { title: 'Register Complaint', to: '/Contact' },
]

export default function FooterSection() {
    return (
        <footer className="py-16 md:py-12">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} LifeTag, All rights reserved</span>
            </div>
        </footer>
    )
}
