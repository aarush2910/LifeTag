"""
Migration script: bypasses app config entirely.
Uses asyncpg + SQLAlchemy directly with Neon credentials.
"""
import asyncio
import sys
import os
...
# Set ALL required env vars before importing app modules
# These match the values in backend/.env exactly
...
from app.db.base import Base  # noqa: F401 — all models registered here
...
async def migrate():
    ...
    print("Done! All tables created (if they did not already exist).")
