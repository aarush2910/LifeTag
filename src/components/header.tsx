...
export const HeroHeader = () => {
  ...
  // default to an actual route from dashboardOptions
  const [dashboardValue, setDashboardValue] = React.useState("/dialog");
  ...
  const renderDashboardDropdown = (isMobile = false) => (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className={cn(
            "relative group text-muted-foreground hover:text-accent-foreground block duration-150",
        ...
        >
          ...
          <span className="pointer-events-none absolute left-0 -bottom-1 h-0.5 w-0 bg-primary transition-all duration-300 group-hover:w-full" />
        </button>
      </DropdownMenuTrigger>
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Right: mobile menu content + actions */}
            <div className="bg-background in-data-[state=active]:block lg:in-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
              ...
              {/* Actions: Login (role dropdown) + Sign Up */}
              <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                {/* Login with role dropdown (Farmer / Vet / Shelter) */}
