...
from app.api.v1 import auth, complaints, vet, shelter, cattles, vet_vaccination, vet_health ,vet_get_cattles
...
app.include_router(vet_get_cattles.router, prefix="/api/vet/appointments-extra")
